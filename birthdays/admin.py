...
class WithdrawalRequestAdmin(admin.ModelAdmin):
    list_display = ("profile", "page", "amount", "mpesa_withdrawal_fee", "status", "payout_phone", "created_at")
    list_filter = ("status", "created_at")
    search_fields = ("profile__username", "profile__user__email", "payout_phone", "note", "page__slug")
    date_hierarchy = "created_at"
